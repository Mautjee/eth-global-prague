    ...
    Ownable
{
    ...
    {
        minVotesRequired = 1; // Minimum votes required for a proposal to pass
    }

    function addAuthorizedVoter(address voter) external onlyOwner {
    ...
    function propose(
        ...
        require(authorizedVoters[msg.sender], "Not authorized to propose");
    ...
    // Required for GovernorTimelockControl in OZ v5
